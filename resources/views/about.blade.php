...
@section('container')
    ...
    <div class="container">
        <div class="row">
            ...
            <section class="col-sm-8 maincontent">
                ...
                <p>Menjadikan santri bisa membaca, melafalkan, menghafalkan dan mengamalkan Al-Quran serta membuat pribadi yang beriman, bertaqwa dan berbudi pekerti.</p>               
            </section>
            <!-- /main -->
    ...
    <section class="team-content">
        <div class="container">
            <div class="row">
                 <div class="col-md-12"> <h3>Tim Kami</h3>
                 </div>                 
            </div>
            <div class="row">  
